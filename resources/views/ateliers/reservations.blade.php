        ...
        <div class="bg-white rounded-lg shadow p-6 mb-6">
            ...
            @if($noteMoyenne !== null)
                <a href="{{ route('ateliers.commentaires', $atelier->getKey()) }}"
                   class="mt-4 flex items-center gap-2 p-3 bg-yellow-50 rounded-lg border border-yellow-200 hover:bg-yellow-100 transition-colors group">
                    ...
                    <span class="ml-auto text-xs text-gray-600 group-hover:text-gray-800 transition-colors">Voir tous les avis →</span>
                </a>
            @else
                <div class="mt-4 flex items-center gap-2 p-3 bg-gray-50 rounded-lg border border-gray-200">
                    <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/>
                    </svg>
                    <span class="text-xs text-gray-500">Aucun avis pour cet atelier</span>
                </div>
            @endif
